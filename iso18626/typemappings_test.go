...
func TestIsTransitionValid(t *testing.T) {
	tests := []struct {
		...
		{TypeStatusExpectToSupply, TypeStatusRetryPossible, true},
		...
		{TypeStatusWillSupply, TypeStatusRetryPossible, true},
		...
		{TypeStatusRetryPossible, TypeStatusOverdue, false},
		{TypeStatusRetryPossible, TypeStatusRecalled, false},
		{TypeStatusRetryPossible, TypeStatusCancelled, false},
		{TypeStatusRetryPossible, TypeStatusCompletedWithoutReturn, false},
		{TypeStatusRetryPossible, TypeStatusCopyCompleted, false},
