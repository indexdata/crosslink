...
func TestValidateReason(t *testing.T) {
	// Valid reason
	reason := guessReason(iso18626.TypeReasonForMessageRequestResponse, ill_db.RequestAction, "", iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageRequestResponse, reason)
	reason = guessReason(iso18626.TypeReasonForMessageRequestResponse, ill_db.RequestAction, string(iso18626.TypeStatusExpectToSupply), iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageStatusChange, reason)
	reason = guessReason(iso18626.TypeReasonForMessageStatusChange, ill_db.RequestAction, "", iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageRequestResponse, reason)
	reason = guessReason(iso18626.TypeReasonForMessageStatusChange, ill_db.RequestAction, string(iso18626.TypeStatusExpectToSupply), iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageStatusChange, reason)
	reason = guessReason(iso18626.TypeReasonForMessageNotification, ill_db.RequestAction, "", iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageNotification, reason)
	reason = guessReason(iso18626.TypeReasonForMessageNotification, ill_db.RequestAction, string(iso18626.TypeStatusExpectToSupply), iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageNotification, reason)
	reason = guessReason(iso18626.TypeReasonForMessageNotification, ill_db.RequestAction, string(iso18626.TypeStatusWillSupply), iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageNotification, reason)
	reason = guessReason("", ill_db.RequestAction, "", iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageRequestResponse, reason)
	reason = guessReason("", ill_db.RequestAction, string(iso18626.TypeStatusExpectToSupply), iso18626.TypeStatusExpectToSupply)
	assert.Equal(t, iso18626.TypeReasonForMessageStatusChange, reason)
