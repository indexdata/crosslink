...
func TestCheckDuplicateRequest(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			request:        baseRequest,
			peer:           ill_db.Peer{CustomData: directory.Entry{IllConfig: &directory.IllConfig{DuplicateCheckWindowHours: &window0}}},
			wantErr:        nil,
			wantRepoCalled: false,
		},
		{
			...
			request:        baseRequest,
			peer:           ill_db.Peer{CustomData: directory.Entry{IllConfig: &directory.IllConfig{DuplicateCheckWindowHours: &windowNeg}}},
			wantErr:        nil,
			wantRepoCalled: false,
		},
		{
			...
			request:        baseRequest,
			peer:           ill_db.Peer{CustomData: directory.Entry{IllConfig: &directory.IllConfig{DuplicateCheckWindowHours: &window1}}},
