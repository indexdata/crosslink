...
func (r *MockEventBus) CreateTask(illTransactionID string, eventName events.EventName, data events.EventData, eventClass events.EventClass, parentId *string) (string, error) {
	r.TasksCreated++
	return "id1", nil
}
func (r *MockEventBus) CreateTaskBroadcast(illTransactionID string, eventName events.EventName, data events.EventData, eventClass events.EventClass, parentId *string) (string, error) {
	r.BroadcastCreated++
	return "id2", nil
}
